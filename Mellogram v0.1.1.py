#[{name: Mellogram}{version: 0.1.0 beta 3}{site: "https://mell-anderson.github.io/Mellogram/"}]
import time
import tempfile
import os
import sys
...
def Shop():
    global QuantitySell, QuantityBuy, InventoryItePassport, InventoryQuantityMachine, nip, MachineBuy, PassportBuy, MachineSell, PassportSell, Machine, Passport, InventoryItemMachine, InventoryQuantityPassport
    ...
    if mnb ==  1 and jkp == "Buy":
        ...
        while True:
            try:
                ...
                jojo()
                Shop()
        if int(InventoryQuantityMachine) >= int(QuantitySell) and int(QuantityBuy) < int(Machine):
