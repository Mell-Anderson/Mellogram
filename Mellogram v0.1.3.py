    ...
    #Companies
        ...
        while True:
            try:
                ...
                nip2 = toFixed(nip, 8)
                biy = int(input("Video cards are an important thing in mining, the better the easier it is to mine.\n[ 1 ] GeForce GTX 2080 ("+str(nip2)+"/"+str(MoneyApple2)+") \n[ 2 ] GeForce GTX 1060 ("+str(nip2)+"/"+str(MoneySumsung2)+") \n[ 3 ] GeForce GTX 750 ("+str(nip2)+"/"+str(MoneyMicrosoft2)+") \n⋗ "))
                break
            except ValueError:
                jojo()
                mone()
